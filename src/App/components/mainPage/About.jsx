...
const About = () => {
  return (
    <div className="padding mt-10 w-full">
      ...
      <div className="mt-10 w-full py-10 md:flex md:justify-between">
        <div
        ...
        <div className="w-full my-4 md:-mt-8 md:-ml-14 md:w-3/5 lg:w-4/5 md:mx-4 ">
          <div className="w-full h-full sm:px-10 sm:py-10 md:px-24 md:py-20 shadow-2xl ">
            <h3 className="text-xl font-medium text-pink-400 mt-4">SLOW FLOWERS’ FLORAL INSIGHTS</h3>
            <h1 className="text-3xl font-serif mt-4">Dried flowers are having a renaissance</h1>
            <p className="mt-4 font-thin text-xl">This awareness has been stimulated by sustainable sourcing practices and the desire on the part of North American flower growers to “extend the season” beyond the last frost.</p>
            <button className="mt-4 px-8 py-2 bg-pink-500 rounded-3xl text-slate-100 font-semibold">CONTACT US</button>
          </div>
        </div>
      </div>
    </div>
